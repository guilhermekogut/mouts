...
{
    public class UpdatedSaleHandler : INotificationHandler<SaleUpdatedEvent>
    {
        private readonly IServiceBusPublisher _serviceBusPublisher;
        private readonly ILogger<SaleCreatedEventHandler> _logger;

        public UpdatedSaleHandler(IServiceBusPublisher serviceBusPublisher, ILogger<SaleCreatedEventHandler> logger)
        {
