...
public class ListProductsByCategoryHandler : IRequestHandler<ListProductsByCategoryCommand, ListProductsByCategoryResult>
{
    ...
    public Task<ListProductsByCategoryResult> Handle(ListProductsByCategoryCommand query, CancellationToken cancellationToken)
    {
        var productsQuery = _productRepository.QueryByCategory(query.Category);
